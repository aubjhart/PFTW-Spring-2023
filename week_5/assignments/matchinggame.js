...
function preload() {
    ...
    cardFaceArray = [
        loadImage('images/bikehorn.png'),
        loadImage('images/feather.png'),
        loadImage('images/flowerpot.png'),
        loadImage('images/juggle.png'),
        loadImage('images/marbles.png'),
        loadImage('images/megaphone.png'),
        loadImage('images/pie.png'),
